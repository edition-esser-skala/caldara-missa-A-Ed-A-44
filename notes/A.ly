...
AgnusAlto = {
  \relative c' {
    ...
    \mvTr g'4.\pE^\solo g8 g([ e16 d)] c8 g'
    a4 a8 a g4 g8 a
    f4. f8 e4 e
    r e8 f g f e d
    cis2 d4 r %5
    ...
    a r r2
    R1*5 %13
    r4 \mvTr g'8\fE^\tuttiE g a4 a8 a
    g4 g8 g e4 e8 e %15
    e4 e e( d) \noBreak
    e2 r\fermata \bar "||"
    \tempoDona R1*4 %21
    ...
    r2 a4. a8 %45
    a f g([ a)] d,4 \once \tieDashed b'~
    b8[ a16 g] a8[ g] f[ g] \once \tieDashed a4~
    ...
    g4 g4. f16[ e] f8[ a16 g] %55
    f4 f4. e16([ d)] e8 g16([ f)]
    e8 e e16([ f g8)] c,4 r
    r8 g'( a4) g r
    a4. g8^\critnote g4. g8
    g4. f8 f g f4 %60
    e8([ g)] g4 g r
    r8 g4 g8 f f g4
    g r r g8 g
